...
Extern
	...
	Function Soloud_getApproximateVolume:Float(aSoloud:Byte Ptr, channel:Int)
	Function Soloud_getStreamPosition:Double(aSoloud:Byte Ptr, aVoiceHandle:Int)
...
Rem
bbdoc: Some parameter is invalid
end rem
...
Rem
bbdoc: File found, but could not be loaded
end rem
Const FILE_LOAD_FAILED:Int = 3
Rem
bbdoc: DLL not found, or wrong DLL
end rem
